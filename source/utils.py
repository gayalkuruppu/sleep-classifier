...
def get_classifiers():
    return [
        AttributedClassifier(name='Random Forest',
            ...
            # AttributedClassifier(name='SVM', classifier=SVC(gamma='auto', verbose=False)),
            AttributedClassifier(name='Neural Net',
                                 classifier=MLPClassifier(activation='relu', hidden_layer_sizes=(15, 15, 15),
                                                          ...
                                                          n_iter_no_change=20)),
            AttributedClassifier(name='My Gradient Boosting', classifier=MyGradientBoostingClassifier(response_method='predict_proba')),
            AttributedClassifier(name='Naive Bayes', classifier=MultinomialNB()),
            ]
