...
class PerformanceBuilder(object):
    ...
    def build_with_sleep_threshold(raw_performance, sleep_threshold):
        ...
        wake_correct = recall_score(raw_performance.true_labels, predicted_labels, pos_label=SleepWakeLabel.wake.value, zero_division=zero_division)
        sleep_correct = recall_score(raw_performance.true_labels, predicted_labels,
                                     pos_label=SleepWakeLabel.sleep.value, zero_division=zero_division)
        ...
        wake_predictive_value = precision_score(raw_performance.true_labels, predicted_labels,
                                                pos_label=SleepWakeLabel.wake.value, zero_division=zero_division)
