...
class TestPerformanceBuilder(TestCase):
    ...
    def test_build_from_raw(self):
        ...
        sleep_predictive_value = precision_score(raw_performance.true_labels, predicted_labels, pos_label=1, zero_division=zero_division)
        wake_predictive_value = precision_score(raw_performance.true_labels, predicted_labels, pos_label=0, zero_division=zero_division)
        false_positive_rates, true_positive_rates, thresholds = roc_curve(raw_performance.true_labels,
                                                                          ...
                                                                          pos_label=1,
                                                                          drop_intermediate=False, zero_division=zero_division)
